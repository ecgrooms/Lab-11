...
public class GraphicalCalculatorFrame extends JFrame
{
	...
	private final class GraphicalCalculatorPanel extends JPanel implements MouseListener
	{
		...
		private void setupRegions()
		{
			...
			regions[0] = new Rectangle(REGION_START_X, REGION_START_Y, REGION_WIDTH, REGION_HEIGHT);
			regions[1] = new Rectangle(REGION_START_X + REGION_INC_X, REGION_START_Y, REGION_WIDTH, REGION_HEIGHT);
			regions[2] = new Rectangle(REGION_START_X + REGION_INC_X * 2, REGION_START_Y, REGION_WIDTH, REGION_HEIGHT);
			regions[3] = new Rectangle(REGION_START_X + REGION_INC_X * 3, REGION_START_Y, REGION_WIDTH, REGION_HEIGHT);
			regions[4] = new Rectangle(REGION_START_X + REGION_INC_X * 4, REGION_START_Y, REGION_WIDTH, REGION_HEIGHT);		
		...
		protected void paintComponent(Graphics g)
		{
			...
			g.drawRect(REGION_START_X, REGION_START_Y, REGION_WIDTH, REGION_HEIGHT);
			g.drawRect(REGION_START_X + REGION_INC_X, REGION_START_Y, REGION_WIDTH, REGION_HEIGHT);
			g.drawRect(REGION_START_X + REGION_INC_X * 2, REGION_START_Y, REGION_WIDTH, REGION_HEIGHT);
			g.drawRect(REGION_START_X + REGION_INC_X * 3, REGION_START_Y, REGION_WIDTH, REGION_HEIGHT);
			g.drawRect(REGION_START_X + REGION_INC_X * 4, REGION_START_Y, REGION_WIDTH, REGION_HEIGHT);
			...
			g2d.fill(regions[selectedRegion]);
    ...
    JLabel errorMessage = new JLabel("No error");
